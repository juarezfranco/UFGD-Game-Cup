...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" href="#regras">Regulamento</a>
                    </li>
                    <li>
        ...
        <div class="regras-section">
            <div class="container">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <!--<a href="RegulamentoUFGDGameCup.pdf" class="btn btn-default btn-lg">baixar pdf</a>-->
                    <ul class="list-inline banner-social-buttons">
                        <li>
                            <a href="RegulamentoUFGDGameCup.pdf" class="btn btn-default btn-lg"><i class="fa fa-file-pdf-o"></i><span class="network-name">&nbspdownload</span></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-10 col-lg-offset-2">
                ...
                <!-- DESCOMENTAR APENAS QUANDO LIBERAR INSCRIÇÃO-->
                    <?php 
                        ...
                        $user = new Usuario();
                        $vagasPalestras = $user->vagasPalestras();
                        $totalPalestra =70;
                        $totalCampeonato=16;
                    ...
                    <?php }else { ?>
                            <div class="col-lg-5 margin-bottom">
                                <button type="button" class="btn btn-danger btn-lg" href="#" disabled="">1ª opção: Vagas esgotadas </button>
                            </div>
                    <?php } 
                        $equipe = new Equipe();
                        $vagasCampeonato = $equipe->vagasCampeonato();
                    ...
                    <?php } else { ?>
                            <div class="col-lg-5 margin-bottom">
                                <button id="btn-cad2"type="button" class="btn btn-danger btn-lg" disabled="">2ª opção: Vagas esgotadas</button>
                                <p style="color:#d9534f;font-size:11px">Dia 8 pode abrir mais vagas, caso alguma equipe não confirme participação até la.</p>
                            </div>
                    <?php } ?>
    ...
    <footer>
        <div class="container text-center">
            ...
            <p class="text-muted credit" style="font-size:14px;">Site desenvolvido por Juarez A. Franco Jr</p>
        </div>
    </footer>
